...
class CarApp(App):
    ...
    def build(self):
        ...
        clearbtn = Button(text="clear", opacity="0.3")
        savebtn = Button(text="save", pos=(parent.width, 0), opacity="0.3")
        loadbtn = Button(text="load", pos=(2 * parent.width, 0), opacity="0.3")
        savesandbtn = Button(text="save sand", pos=(3 * parent.width, 0), opacity="0.3")
        loadsandbtn = Button(text="load sand", pos=(4 * parent.width, 0), opacity="0.3")
